...
Throughout the development of these portfolio pieces (and my broader job search), I used Claude to get hands-on experience using an AI tool in a technical writing workflow. Claude helped me brainstorm my overall approach, gave feedback on structure and clarity, and guided me through understanding the technical concepts behind the writing. The documentation itself — the writing, the decisions about what to include, the testing in Postman, the structure — is my own work. AI helped me think and stay organized; the actual words are my own.
